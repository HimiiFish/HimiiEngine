...
namespace Himii
{
    ...
    void ImGuiLayer::OnAttach()
    {
        ...
        ImGuiPlatformBackend::Initialize(window.GetNativeWindow());
    ...
    void ImGuiLayer::LoadEditorFonts()
    {
        ...
        float scaleX = 1.0f;
        float scaleY = 1.0f;
        application.GetWindow().GetContentScale(scaleX, scaleY);
        const float user_interface_scale = scaleX;
        HIMII_CORE_INFO("Window Content Scale: {0}, {1}", scaleX, scaleY);
        ...
        ImGuiPlatformBackend::RecreateDeviceObjects();
    }
    ...
    void ImGuiLayer::End()
    {
        ...
        ImGui::Render();
        ImGuiPlatformBackend::RenderDrawData(ImGui::GetDrawData());
        if (io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable)
            ImGuiPlatformBackend::RenderPlatformWindows();
    }
